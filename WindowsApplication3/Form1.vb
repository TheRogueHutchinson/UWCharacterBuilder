...
#Region "Utility Methods"
	...
	Private Sub Costs()
		...
		SpentCP = SpentCP + Int(costCraft2.Text) * skillCraft2.Value
		SpentCP = SpentCP + Int(costCraft3.Text) * skillcraft3.Value
		SpentCP = SpentCP + Int(costCraft4.Text) * skillCraft4.Value
		...
		SpentCP = SpentCP + Int(costLocksmith.Text) * skillLocksmith.Value
		...
		If Race = 821 Then SpentCP = SpentCP + (Int(costRacial1.Text)) * (skillRacial1.Value - 1)
		...
		If FavouredCheck.Checked = True Then SpentCP = SpentCP + 50
	...
	Public Sub SkillListBuild()
		...
		If skillCraft1.Value > 0 Then boxSkillBreakdown.AppendText(lblCraft1.Text & " " & boxCraft1.Text & " X " & skillCraft1.Value & "   " & costCraft1.Text * skillCraft1.Value & vbNewLine)
		If skillCraft2.Value > 0 Then boxSkillBreakdown.AppendText(lblCraft1.Text & " " & boxCraft2.Text & " X " & skillCraft2.Value & "   " & costCraft2.Text * skillCraft2.Value & vbNewLine)
		If skillcraft3.Value > 0 Then boxSkillBreakdown.AppendText(lblCraft1.Text & " " & boxCraft3.Text & " X " & skillcraft3.Value & "   " & costCraft3.Text * skillcraft3.Value & vbNewLine)
		If skillCraft4.Value > 0 Then boxSkillBreakdown.AppendText(lblCraft1.Text & " " & boxCraft4.Text & " X " & skillCraft4.Value & "   " & costCraft4.Text * skillCraft4.Value & vbNewLine)
		...
		If skillLocksmith.Value > 0 Then boxSkillBreakdown.AppendText(lblLocksmith.Text & " X " & skillLocksmith.Value & "   " & costLocksmith.Text * skillLocksmith.Value & vbNewLine)
		...
		If Race <> 802 AndAlso Race <> 0 Then
			boxSkillBreakdown.AppendText("Racial: " & lblRacial1.Text)
		End If
		...
		ElseIf Race = 829 Then
			boxSkillBreakdown.AppendText(" Level " & skillRacial1.Value)
		...
		If FavouredCheck.Checked = True Then boxSkillBreakdown.AppendText("Favoured   50" & vbNewLine)
	...
	Public Sub Production()
		...
		Select Case Job
			Case 1000
				costAlchemy.Text = 80
				costBlacksmith.Text = 45
				costCraft1.Text = 40
				costCreateScroll.Text = 75
				costTrapsmith.Text = 60
			Case 1001
				costAlchemy.Text = 50
				costBlacksmith.Text = 45
				costCraft1.Text = 40
				costCreateScroll.Text = 75
				costTrapsmith.Text = 50
			Case 1002
				costAlchemy.Text = 70
				costBlacksmith.Text = 50
				costCraft1.Text = 40
				costCreateScroll.Text = 40
				costTrapsmith.Text = 60
			Case 1003
				costAlchemy.Text = 40
				costBlacksmith.Text = 60
				costCraft1.Text = 40
				costCreateScroll.Text = 50
				costTrapsmith.Text = 30
			Case 1004
				costAlchemy.Text = 40
				costBlacksmith.Text = 70
				costCraft1.Text = 40
				costCreateScroll.Text = 75
				costTrapsmith.Text = 40
			Case 1005
				costAlchemy.Text = 50
				costBlacksmith.Text = 60
				costCraft1.Text = 40
			...
			Case 1011 To 1113
				...
				costTrapsmith.Text = 70
		End Select
		costCraft2.Text = costCraft1.Text
		costCraft3.Text = costCraft1.Text
		costCraft4.Text = costCraft1.Text
	End Sub
	Public Sub Circles()
	...
	Public Sub SetJobSkills()
		...
		Select Case Job
			...
			Case 1009
				...
				skillJob1.Maximum = 1
				lblJob2.Text = "Control L. Undead"
				lblJob3.Text = "Rod of Infliction"
				lblJob4.Text = "Scion of Darkness"
			Case 1010
				lblJob1.Text = "Defender"
				skillJob1.Maximum = 1
				lblJob2.Text = "Lay on Hands"
				lblJob3.Text = "Smite Blasphemer"
				lblJob4.Text = "Sunstorm"
			Case 1011
				lblJob1.Text = "Greater Bless"
				lblJob2.Text = "Desecrate"
			...
			Case 1013
				...
				skillJob1.Maximum = 1
				lblJob2.Text = "Saturation"
				lblJob3.Text = "Spell Recall"
				lblJob4.Text = "Draconic Rebirth"
			Case 1100
	...
	Public Sub RaceBonus()
		...
		Select Case Race
			Case 800
				...
				lblRacial1.Text = "Eyes of the Mother"
				...
				lblRacial1.Visible = False
				costRacial1.Visible = False
				skillRacial1.Visible = False
				listRacial.Visible = False

			Case 801
				lblRacial2.Text = "Spite Blood"
				lblRacial1.Text = "Natural Chemists"
				skillRacial2.Maximum = 100
				skillBPB.Maximum = 0
				skillStr.Maximum = 0
				lblRacial2.Visible = True
			...
			Case 803
				...
				lblRacial1.Text = "Alternate Healing"
				skillRacial2.Maximum = 100
				skillBPB.Maximum = 2
				skillStr.Maximum = 0
				NoBod = False
			...
			Case 804
				...
				lblRacial1.Text = "Magical Aptitude"
				skillRacial2.Maximum = 100
				skillBPB.Maximum = 0
				skillStr.Maximum = 0
				lblRacial2.Visible = True
			...
			Case 806
				lblRacial2.Text = ""
				lblRacial1.Text = "Character Point Bonus   +50CP"
			...
			Case 808
				...
				lblRacial1.Text = "Immune to Fear"
			...
			Case 809
				lblRacial2.Text = "Nine Lives"
				lblRacial1.Text = "Naturals Claws"
				lblRacial1.Visible = True
			...
			Case 814
				...
				lblRacial1.Text = "Natural Threshold"
				skillRacial2.Maximum = 100
				skillBPB.Maximum = 0
				skillStr.Maximum = 0
				lblRacial2.Visible = True
			...
			Case 815
				...
				lblRacial1.Text = "Permanent Non-Detection"
				skillRacial2.Maximum = 100
				skillBPB.Maximum = 0
				skillStr.Maximum = 0
				lblRacial2.Visible = True
			...
			Case 816
				...
				lblRacial1.Text = "Forest Revival"
				skillRacial2.Maximum = 100
				skillBPB.Maximum = 0
				skillStr.Maximum = 0
				lblRacial2.Visible = True
			...
			Case 817
				...
				lblRacial1.Text = "Simple Weapon Bonus Damage"
				lblRacial2.Visible = True
				costRacial2.Visible = True
				skillRacial2.Visible = True
				skillRacial2.Maximum = 100
			...
			Case 820
				...
				lblRacial1.Text = "Learning Aptitude - Shenanigans"
				skillRacial2.Maximum = 100
				skillBPB.Maximum = 0
				skillStr.Maximum = 0
				lblRacial2.Visible = True
			...
			Case 823
				...
				lblRacial1.Text = "Enhanced Strength - Strength +1"
				skillRacial2.Maximum = 100
				skillBPB.Maximum = 0
				skillStr.Maximum = 4
				lblRacial2.Visible = True
			...
			Case 824
				...
				lblRacial1.Text = "Ogre Constitution"
				skillRacial2.Maximum = 100
				skillBPB.Maximum = 0
				skillStr.Maximum = 0
				lblRacial2.Visible = True
			...
			Case 825
				...
				lblRacial1.Text = "Immunity to Magic"
				lblRacial2.Visible = True
				costRacial2.Visible = True
				skillRacial2.Visible = True
				skillRacial2.Maximum = 100
			...
			Case 827
				lblRacial2.Text = "Formless Casting"
				lblRacial1.Text = "Magic Echo"
				lblRacial2.Visible = True
				costRacial2.Visible = True
				skillRacial2.Visible = True
				skillRacial2.Maximum = 1
			...
			Case 829
				lblRacial2.Text = "Resist Psionics"
				lblRacial1.Text = "Empathic Touch"
				lblRacial2.Visible = True
				costRacial2.Visible = True
				skillRacial2.Visible = True
				lblRacial1.Visible = True
				costRacial1.Visible = True
				skillRacial1.Visible = True
				listRacial.Visible = False
				skillRacial1.Maximum = 3
				skillRacial2.Maximum = 100
				skillBPB.Maximum = 0
				skillStr.Maximum = 0
			...
			Case 831
				lblRacial2.Text = "Sense Undead"
				lblRacial1.Text = "Natural Hide"
				lblRacial2.Visible = True
				costRacial2.Visible = True
				skillRacial2.Visible = True
				skillRacial2.Maximum = 1
		...
		Select Case Race
			...
			Case 821
				If skillRacial2.Value + skillBPB.Value + skillStr.Value + (skillRacial1.Value - 1) = Int((Level + 1) / 2) Then
					skillRacial2.Maximum = skillRacial2.Value
					skillBPB.Maximum = skillBPB.Value
					skillStr.Maximum = skillStr.Value
					skillRacial1.Maximum = skillRacial1.Value
				End If
				If skillRacial2.Value + skillBPB.Value + skillStr.Value + (skillRacial1.Value - 1) > Int((Level + 1) / 2) Then
					...
					If skillRacial1.Value > 0 Then skillRacial1.Value = skillRacial1.Value - 1
				End If
			Case Else
	...
	Private Sub CountBlankets_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles numericBlanketAmt.ValueChanged
		Select Case numericBlanketAmt.Value
			...
			Case 122
				BlanketCP = 2050
			Case 122 To 9999
				BlanketCP = 2050 + 10 * (numericBlanketAmt.Value - 122)
		End Select
...
"Player: " & PlayerName & vbNewLine & "Character: " & CharacterName & vbNewLine & "Race: " & RaceName & vbNewLine & "Occupation: " & JobName & vbNewLine & "Level: " & Level & vbNewLine & "Hit Points: " & HPTotal() & vbNewLine & "Blankets Applied: " & numericBlanketAmt.Value & vbNewLine & "Total CP: " & TotalCP & vbNewLine & "Spent CP: " & SpentCP & vbNewLine & "Free CP: " & FreeCP & vbNewLine & "Skills: " & vbNewLine & boxSkillBreakdown.Text, False)
	...
	Private Sub SkillRacial1_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles skillRacial1.ValueChanged
		Recalc()
	End Sub
	...
	Private Sub BtnOpenFile_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOpenFile.Click
        ...
        If OpenFileDialog1.FileName <> "" Then
            ...
            If InBox.Items.Count > 96 Then FavouredCheck.Checked = InBox.Items(96)
            ...
            skillLocksmith.Value = InBox.Items(55)
            ...
            skillRacial1.Value = InBox.Items(76)
            ...
            skillSpellVersa1.Value = InBox.Items(83)
            skillSpellVersa2.Value = InBox.Items(84)
            skillSpellVersa3.Value = InBox.Items(85)
            skillSpellVersa4.Value = InBox.Items(86)
            skillSpellVersa5.Value = InBox.Items(87)
            skillSpellVersa6.Value = InBox.Items(88)
            skillSpellVersa7.Value = InBox.Items(89)
            skillSpellVersa8.Value = InBox.Items(90)
            skillSpellVersa9.Value = InBox.Items(91)
            ddlEleAttunement1.SelectedIndex = InBox.Items(92)
            ddlEleAttunement2.SelectedIndex = InBox.Items(93)
            ddlEleAttunement3.SelectedIndex = InBox.Items(94)
            ddlEleAttunement4.SelectedIndex = InBox.Items(95)
            FavouredCheck.Checked = InBox.Items(96)
            skillCraft2.Value = InBox.Items(97)
            skillcraft3.Value = InBox.Items(98)
            skillCraft4.Value = InBox.Items(99)
            boxCraft1.Text = InBox.Items(100)
	...
	Private Sub SkillCraft1_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles skillCraft1.ValueChanged
		If skillCraft1.Value > 0 Then
			boxCraft1.Enabled = True
			skillCraft2.Enabled = True
		Else
			boxCraft1.Enabled = False
			boxCraft1.Text = ""
			skillCraft2.Enabled = False
			skillCraft2.Value = 0
		End If
		Recalc()
	End Sub

	Private Sub SkillCraft2_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles skillCraft2.ValueChanged
		If skillCraft2.Value > 0 Then
			boxCraft2.Enabled = True
			skillcraft3.Enabled = True
		Else
			boxCraft2.Enabled = False
			boxCraft2.Text = ""
			skillcraft3.Enabled = False
			skillcraft3.Value = 0
		End If
		Recalc()
	End Sub

	Private Sub Skillcraft3_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles skillcraft3.ValueChanged
		If skillcraft3.Value > 0 Then
			boxCraft3.Enabled = True
			skillCraft4.Enabled = True
		Else
			boxCraft3.Enabled = False
			boxCraft3.Text = ""
			skillCraft4.Enabled = False
			skillCraft4.Value = 0
		End If
		Recalc()
	End Sub

	Private Sub SkillCraft4_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles skillCraft4.ValueChanged
		If skillCraft4.Value > 0 Then
	...
	Private Sub FavouredCheck_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles FavouredCheck.CheckedChanged
		Recalc()
	End Sub
...
#Region "Rogue Handles"
	...
	Private Sub SkillLocksmith_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles skillLocksmith.ValueChanged
		Recalc()
	End Sub
